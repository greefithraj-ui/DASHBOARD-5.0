...
import { Menu, AlertCircle, ExternalLink, RefreshCw, Database, Copy, Check, LogOut } from 'lucide-react';
              ...
              <div className="flex items-center gap-4">
                ...
                {(loading || isBackgroundSyncing) && (
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-[#38bdf8]/10 border border-[#38bdf8]/20 rounded-full animate-pulse">
                    ...
                    <span className="text-[9px] font-black text-[#38bdf8] uppercase tracking-widest">
